...
private:
  ...
  QMap<QString, QPushButton *> buttons_ = {
      ...
      {"uninstall",
       new QPushButton(QPushButton::tr("Uninstall Package"), this)},
      {"github", new QPushButton(QPushButton::tr("GitHub"), this)},
      {"railospath", new QPushButton(QPushButton::tr("Set RailOS"), this)},
      {"open_railos_dir",
       new QPushButton(QPushButton::tr("Open RailOS Folder"), this)},
      {"launch_railos",
       new QPushButton(QPushButton::tr("Launch RailOS"), this)}};
