...
private:
  ...
  void check_is_file_(const QString &file_path, const QString &suffix = "") {
    if (!QFileInfo(file_path).isFile()) {
      const QString err_ =
          "File '" + file_path + "' does not exist, or is invalid.";
      QMessageBox::critical(parent_, QMessageBox::tr("Invalid File"),
    ...
    if (!suffix.isEmpty() && QFileInfo(file_path).completeSuffix() != suffix) {
      ...
      QMessageBox::critical(parent_, QMessageBox::tr("Invalid File Type"),
                            QMessageBox::tr(err_.toStdString().c_str()));
...
public:
   ...
   * **************************************************************************/
  Packager(QWidget *parent, const QString &railos_loc,
   ...
   * *************************************************************************/
  void addContributor(const QString &contributor) {
